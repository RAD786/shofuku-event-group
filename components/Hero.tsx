export function Hero() {
  return (
    <section
      id="hero"
      className="relative isolate min-h-screen bg-ink pt-32"
    >
      <div className="absolute inset-0 -z-20 bg-[url('/images/hero-background.png')] bg-cover bg-center" />
      <div className="absolute inset-0 -z-10 bg-[linear-gradient(90deg,rgba(248,244,235,0.94)_0%,rgba(248,244,235,0.82)_42%,rgba(248,244,235,0.46)_68%,rgba(248,244,235,0.25)_100%)] dark:bg-[linear-gradient(90deg,rgba(5,5,4,0.92)_0%,rgba(5,5,4,0.76)_45%,rgba(5,5,4,0.42)_72%,rgba(5,5,4,0.22)_100%)]" />
      ...
      <div className="absolute inset-0 -z-10 opacity-70 dark:opacity-45">
      ...
      <div className="section-shell grid min-h-[calc(100vh-8rem)] items-center gap-12 pb-24 lg:grid-cols-[1.05fr_0.95fr]">
        <div className="max-w-4xl">
          ...
          <p className="mt-7 max-w-2xl text-lg leading-8 text-ink/72 dark:text-ivory/72 md:text-xl">
          ...
          <div className="mt-12 grid max-w-2xl gap-4 border-y border-ink/10 py-5 text-xs font-bold uppercase tracking-[0.18em] text-ink/55 dark:border-ivory/10 dark:text-ivory/48 sm:grid-cols-3">
